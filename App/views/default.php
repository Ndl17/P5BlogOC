...
<head>
  ...
  <title>Projet Blog - OpenClassroom</title>
      ...
      <li class="menu-item active open">
        ...
        <ul class="menu-sub">
          ...
          <?php  if (isset($_SESSION['user']) && !empty($_SESSION['user'])) {
            ?>
            <li class="menu-item">
              <a href="/article/ajout" class="menu-link">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="/admin/index" class="menu-link">
                  <div data-i18n="Account">Modération Articles</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="/admin/validComment" class="menu-link">
        ...
        <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
          ...
          <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <?php }else {
              ...
              <button type="button" class="btn" style="margin-right: -30px"><a href="/user/login" class="btn rounded-pill btn-primary btn-sm">Connexion</a></button>
              <button type="button" class="btn"><a href="/user/register" class="btn rounded-pill btn-secondary btn-sm">S'inscrire</a></button>
            <?php } ?>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
              <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                <div class="avatar avatar-online">
                  <img src="../../assets/img/avatars/undraw_profile_2.svg" alt class="w-px-40 h-auto rounded-circle" />
                </div>
              </a>
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        ...
                        {
                          ?>
                          <span class="fw-semibold d-block"><?php echo $_SESSION["user"]['pseudo']; ?></span>
                        <?php }else {
                          ?>
        ...
        <footer class="content-footer footer bg-footer-theme">
          <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
            ...
            <div>
              ...
              <a href="admin/loginAdmin" target="_blank" class="footer-link me-4">Connexion Admin</a>
<?php } ?>
