...
<head>
  ...
  <title>Login - Projet Blog OC</title>
  ...
  <div class="container-xxl">
    <div class="authentication-wrapper authentication-basic container-p-y">
      <div class="authentication-inner">
        <!-- Register -->
        <a href="/main" class="btn rounded-pill btn-primary" id="returnBtn"><i class="bx bx-chevron-left bx-sm align-middle"style="color:#696cff" id="iconReturn"></i>Retour</a>
